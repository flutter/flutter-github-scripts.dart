...
echo -n "Contributors..."
dart bin/notable-contributors.dart --closed $FROM $TO > notable-contributors.md
echo "done."
echo -n "Clusters..."
dart bin/clusters.dart --closed --labels --prs $FROM $TO > prs_merged_by_label.md
echo "done."
echo -n "PRs merged..."
dart bin/prs.dart --closed $FROM $TO > prs_merged.md
echo "done."
